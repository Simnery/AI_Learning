...
> 整理日期：2026-05-30
> **可自学扩展版**：`papers_self/AI大模型应用开发工程师知识图谱/`（66 篇叶子教程 + 本章导读）
...
| 阶段 | 章节 | 导读 | 周期参考 |
|:---:|------|------|:---:|
| 1 | AI大模型基础 | [01 章 README](AI大模型应用开发工程师知识图谱/01_AI大模型基础/README.md) | 2–3 周 |
| 2 | AI应用技术 | [02 章 README](AI大模型应用开发工程师知识图谱/02_AI应用技术/README.md) | 4–5 周 |
| 3 | AI框架及工具平台 | [03 章 README](AI大模型应用开发工程师知识图谱/03_AI框架及工具平台/README.md) | 3 周 |
| 4 | AI研发新范式 | [04 章 README](AI大模型应用开发工程师知识图谱/04_AI研发工程师工作新范式/README.md) | 2 周 |
| 5 | 项目实战 | [05 章 README](AI大模型应用开发工程师知识图谱/05_项目实战/README.md) | 3–4 周 |
| 6 | 面试辅导 | [06 章 README](AI大模型应用开发工程师知识图谱/06_专项面试辅导课/README.md) | 1 周 |

**入口节点**：[1-1-1 提示工程→RAG](AI大模型应用开发工程师知识图谱/01_AI大模型基础/1-1_理论知识/1-1-1_从提示工程到RAG构建大模型的知识与交互.md)

下方提纲与 `papers_self` 叶子节点一一对应；深度学习请打开 `papers_self` 中对应 `.md` 文件。
